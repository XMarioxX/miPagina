function text(button) {
    ...
    if (button === "main") {
      selectedText.innerHTML =
        '<span class="text-purple-500">import</span> {Spinner} <span class="text-purple-500">from</span> <span class="text-green-400">"@nextui-org/react"</span>;';
      ...
      selectedText.innerHTML =
        '<span class="text-purple-500">import</span> {Spinner} <span class="text-purple-500">from</span> <span class="text-green-400">"@nextui-org/spinner"</span>;';
