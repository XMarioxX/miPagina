//<!-- Script para cambiar el contenido del div -->
  ...
  mainButton.addEventListener('click', () => {
    ...
    textContainer.textContent = 'import {Input} from "@nextui-org/react";';
  });

  individualButton.addEventListener('click', () => {
    // Cambiar el contenido del div cuando se hace clic en el botón Individual
    textContainer.textContent = 'import {Input} from "@nextui-org/input";"';
  });
...
//<!-- Script para mostrar/ocultar el div transparente y los botones -->
  ...
  function mostrarMenos() {
   ...
   // Agregar/eliminar la clase 'active' en los labels cuando el input está en focus
