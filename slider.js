function text(button) {
    ...
    if (button === "main") {
      selectedText.innerHTML =
        '<span class="text-purple-500">import</span> {Slider} <span class="text-purple-500">from</span> <span class="text-green-200">"@nextui-org/react"</span>;';
      ...
      selectedText.innerHTML =
        '<span class="text-purple-500">import</span> {Slider} <span class="text-purple-500">from</span> <span class="text-green-200">"@nextui-org/slider"</span>;';
  ...
  function git() {
    window.open(
      "https://github.com/nextui-org/nextui/issues/new?assignees=&labels=bug&template=bug_report.yml&title=%5BBUG%5D+-+Slider"
    );
  }
